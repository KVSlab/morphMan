...
from morphman.common.surface_operations import create_new_surface
from morphman.common.vtk_wrapper import read_polydata, get_point_data_array, write_polydata
