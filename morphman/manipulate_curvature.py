...
def make_voronoi_smooth(voronoi, centerline, smoothed_centerline, smooth_line, div_voronoi, div_points):
    """
...
def move_all_centerlines(unsmoothed_centerline, smoothed_centerline, smooth_line, div_offset):
    """
