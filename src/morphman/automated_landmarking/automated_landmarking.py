...
from morphman.automated_landmarking.automated_landmarking_bogunovic import (
    landmarking_bogunovic,
)
from morphman.automated_landmarking.automated_landmarking_piccinelli import (
...
from morphman.common.argparse_common import str2bool
...
def automated_landmarking(
    ...
    if algorithm == "bogunovic":
        landmarks = landmarking_bogunovic(
            ica_centerline,
            base_path,
            approximation_method,
            algorithm,
        ...
        landmarks = landmarking_piccinelli(
            ica_centerline,
            base_path,
            approximation_method,
            algorithm,
...
def read_command_line():
    ...
    parser.add_argument(
        "-fact",
        "--smoothing-factor-torsion",
        type=float,
        default=1.2,
        help="Smoothing factor for computing torsion.",
    )
    parser.add_argument(
        "-it", "--iterations", type=int, default=100, help="Smoothing iterations."
    )
    parser.add_argument(
        "-r",
        "--resampling-step",
    ...
    return dict(
        ...
        approximation_method=args.approximation_method,
        coronal_axis=args.coronal_axis,
        ...
        smoothing_factor_torsion=args.smoothing_factor_torsion,
