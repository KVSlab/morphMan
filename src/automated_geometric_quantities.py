...
def read_command_line():
    ...
    return args.dir_path, args.case, args.curvature, args.angle, args.alpha, args.beta, args.method_curv, args.method_angle, args.boundary


def compute_angle(dirpath, point_path, name, alpha, beta, method, proj=False, new_centerline=None):
    """
    ...
    for folder in folders:
        ...
        for i, alpha in enumerate(alphas):
            for j, beta in enumerate(betas):
                ...
                if theta:
                    angle, old_angle = compute_angle(casedir, point_path, name, alpha, beta, method_angle)
